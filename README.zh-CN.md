...
| 要求 | 当前支持情况 |
| --- | --- |
| **Unreal Engine** | 5.8（[v0.1.2 已验证版本](https://github.com/SeeleAI/seele-scatter-regions/releases/tag/v0.1.2)）；UE 5.5 请使用 v0.1.0 |
...
自动化、示例配方资产，以及面向 UE 5.8 和 UE 5.5 的公开版本。
...
| **不同版本的 Unreal Engine 产物可复现** | 当前 [v0.1.2 Release](https://github.com/SeeleAI/seele-scatter-regions/releases/tag/v0.1.2)、源码与[打包脚本](https://github.com/SeeleAI/seele-scatter-regions/tree/main/Scripts)面向 UE 5.8；[v0.1.0 Release](https://github.com/SeeleAI/seele-scatter-regions/releases/tag/v0.1.0)继续用于 UE 5.5 |
...
使用 Unreal Engine 5.8 时，下载已验证的
[v0.1.2 Release](https://github.com/SeeleAI/seele-scatter-regions/releases/tag/v0.1.2)，
将其中的 `SeeleScatterRegions` 文件夹解压到 Unreal 项目的 `Plugins` 目录。
也可以直接克隆源码：
...
0.1.2 已针对 Unreal Engine 5.8 构建和验证；Unreal Engine 5.5 用户可使用
