...
| **不同版本的 Unreal Engine 产物可复现** | 当前 v0.1.2 源码与[打包脚本](https://github.com/SeeleAI/seele-scatter-regions/tree/main/Scripts)面向 UE 5.8；[v0.1.0 Release](https://github.com/SeeleAI/seele-scatter-regions/releases/tag/v0.1.0)继续用于 UE 5.5 |
